...
void alterar(char nomeArq[], FILE *arquivo) {
	...
	do {
		...
		if(opc=='2') {
			...
			printf ("\n\t Pressione qualquer tecla para voltar para o Menu de Altera��o...\n\n");
		    getch();
		}
...
void apagaReg(char nomeArq[], FILE *arquivo) {
  ...
  //	 Leitura dos registros
			...
			if (achou==1) {
		    	...
		    	if (conf == '1') {
		        	...
		        	getch();
		       		...
		       		printf ("\n\t Produto %s N�O removido...\n\n",x.nome);
		    	}
		    }
				
			else {
				printf ("\n\t Nao h� produto cadastrado com id %d.\n\n",numero);
			}		
		...
		if(opc=='2') {
			...
			printf ("\n\t Pressione qualquer tecla para voltar para o Menu de Exclus�o...\n\n");
		    getch();
		}
...
void listaArquivosPasta(){
    ...
    system("cls");
    printf("Arquivos existentes no diret�rio atual:\n");
    system("tree /f");
...
void criaPasta(){
    ...
    system("cls");
    printf("\n\tCrie uma pasta no diret�rio atual");
...
void renomeiaPasta(){
    ...
    system("cls");
    printf("\n\tEdite o nome de uma pasta no diret�rio atual");
...
void mudarDePasta()
{
	...
	printf("\n\n\tDigite o nome da pasta onde se encontra o arquivo \n\t(se ele estiver no diret�rio atual nao digite nada e apenas pressione enter...)\n\t --> ");
	fflush(stdin);
	gets(pastaAtual);
	...
	printf("\n\n\tDigite o nome da pasta para onde ser� transferido o arquivo\n\t(se quiser transferir para o diret�rio atual nao digite nada e apenas pressione enter...)\n\t --> ");
	fflush(stdin);
	gets(pastaAtual);
...
void mudaCor() {
    ...
    char str[]={"color "};
    fflush(stdin);
    printf("\n\tCaso n�o saiba quais numeros representam quais cores, pode consulta-los no arquivo de ajuda!\n");
